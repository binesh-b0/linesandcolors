...
const Model = (props) => {
  const gltf = useLoader(GLTFLoader, '/models/the_energy_sphere/scene.gltf'); 
  const texture1 = useLoader(TextureLoader, '/models/the_energy_sphere/textures/Material_5_baseColor.png'); 
  const texture2 = useLoader(TextureLoader, '/models/the_energy_sphere/textures/Material_5_emissive.png'); 
